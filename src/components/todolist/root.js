...
class Root extends Component {
    constructor(){
        var windowWidth = document.body.clientWidth+50;
        var windowHeight = window.outerHeight;
        // var html = document.getElementsByTagName("html")[0]
        // var htmlWidth = window.getComputedStyle(html).width;
        // var htmlHeight = window.getComputedStyle(html).height;
    ...
    AccessFiles(e){
        ...
        // let htmlWidth = window.getComputedStyle(html).width;
        // let htmlHeight = window.getComputedStyle(html).height;
        this.setState({
            isShouldSave: true,
    ...
    render() {
        ...
        console.log(localStorage.getItem("myState"));
        console.log(this.state.IMGBackgroundStyle);
        return (
            <div>
                <div className="IMGBackground" style={this.state.IMGBackgroundStyle}></div>      
                <div 
                ...
                {/* 读取本地文件 */}
                <input type="file" id="inputFiles"  onChange={this.AccessFiles}/>
            </div>
        );
    }
}
